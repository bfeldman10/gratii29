		...
		<table width="100%"><tr><td align="center">
			...
			<table bgcolor="#FFFFFF" width="613" style="font-family:arial;color:black;">
				<tr bgcolor="blue">
					<td align="center">
						<br>
						<img src="http://gratii.com/gratii29/app/images/pro/logo.png" alt="Gratii" width="200">
						<br><br>
					</td>
				</tr>
				<tr>
					<td align="center">
						<img src="http://gratii.com/gratii29/app/images/auctions/'.$auctionData['results'][0]['promoPic'].'" alt="'.$auctionData['results'][0]['promoName'].'" style="border-top:2px solid #FFF;border-bottom:2px solid #FFF;">
					</td>
				</tr>
				<tr>
