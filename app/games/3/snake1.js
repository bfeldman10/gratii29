(function(){
	...
	var topUI = function() {
		this.init = function() {
			...
			this.topUIimage.src = 'snake-images/top-ui.png';
		}
		this.draw = function() {
	...
	function loseGame() {	
		...
		if(typeof postScore == 'function')
			postScore(gratii); //passing gratii twice, since score == gratii
			console.log(gratii);
	}
	...
	function controlPad() {
	if (p1.currentDir == 0)
		canvas.getContext("2d").drawImage(controllerUpImage, 0, canvas.height-160);
	if (p1.currentDir == 1)
		canvas.getContext("2d").drawImage(controllerRightImage, 0, canvas.height-160);
	if (p1.currentDir == 2)
		canvas.getContext("2d").drawImage(controllerDownImage, 0, canvas.height-160);
	if (p1.currentDir == 3)
