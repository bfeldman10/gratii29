...
if(myGratii=="wait.."){alert("Please wait for your chips to update. Internet connection is slow.");return;}
...
myGratii="wait..";$.post('../api/gameOver.php',{score:gratiiWinnings},function(data){myGratii=data.gratiiAfter;},"json");}
...
function addBet(amt){player_split_hand=new Array();if(myGratii>=amt){myGratii-=amt;betTotal+=amt;previousBet+=amt;if(betTotal>maxBet){alert("Max bet is "+maxBet+" Gratii");betTotal-=amt;myGratii+=amt;previousBet=betTotal;}}else if(myGratii=="wait.."){alert("Please wait for your chips to update. Internet connection is slow.");}else{alert("Not enough Gratii bro");}}
...
function reBet(){player_split_hand=new Array();if(myGratii>=previousBet){myGratii-=previousBet;betTotal=previousBet;deal();}else if(myGratii=="wait.."){alert("Please wait for your chips to update. Internet connection is slow.");}else{alert("Not enough gratii bro");}}
