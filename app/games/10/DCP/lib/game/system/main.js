...
MyGame = ig.Game.extend({
    ...
    init: function() {
        ...
        $.("../../api/getSlotsJackpot.php", function(data){
            console.log(data);
    ...
    start: function (){
        ...
        // send wager and recieve outcome.
         ...
         $.post("../../api/gameOverSlotsDCP.php", {gratiiWagered: this.wager}, function(data){
            // console.log('return');
            console.log(data);
            // console.log(data.usersCurrentGratii);
        },"json");
        ...
        // modify chance settings & trigger spin



       /* if (data.outcome === "" ) {
            this.config.chances = { gold: 0, cherry: 1, bar: 0, lose: 0 };
           
        }
        if (outcome === (this.gratii+(this.wager*2)) ) {
            this.config.chances = { gold: 1, cherry: 0, bar: 0, lose: 0 };
        }
        */
        ...
        switch (data.outcome){
            ...
            case "double":
                this.config.chances = { gold: 0, cherry: 0, bar: 1, lose: 0 };
            break;
            case "triple":
                this.config.chances = { gold: 0, cherry: 1, bar: 0, lose: 0 };
            break;
            ...
            break;
            default:
                this.config.chances = { gold: 0, cherry: 0, bar: 0, lose: 1 };
            break;
